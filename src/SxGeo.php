...
define ('EARNMORE_SXGEO_FILE', 0);
define ('EARNMORE_SXGEO_MEMORY', 1);
define ('EARNMORE_SXGEO_BATCH',  2);
class SxGeo {
    protected $fh;
    protected $ip1c;
    protected $info;
    ...
    public function __construct($type = EARNMORE_SXGEO_FILE){
        $db_file = dirname(__FILE__) . '/../data/SxGeo.dat';
        ...
        $this->batch_mode  = $type & EARNMORE_SXGEO_BATCH;
        $this->memory_mode = $type & EARNMORE_SXGEO_MEMORY;
